		...
		<form action="artFairsWrite.do" method="post" enctype="multipart/form-data">
			<table align="center" id="table">
				<tr>
					...
					<td class="td"><input class="input" type="text" name="title" placeholder="Fair 이름" required="required"></td>
				</tr>
				<tr>
					<td class="td">Fair Date</td>
					<td class="td"><input class="input" type="text" name="afdate" placeholder="MainPage 표기날짜" required="required"></td>
				</tr>
				<tr>
					<td class="td">Fair Detail Date</td>
					<td class="td"><input class="input" type="text" name="info_date" placeholder="세부Page 표기날짜" required="required"></td>
				</tr>
				<tr>
					<td class="td">Fair Info</td>
					<td class="td"><input class="input" type="text" name="info" placeholder="Fair 전시지역" required="required"></td>
				</tr>
				<tr>
					<td class="td">Fair Place</td>
					<td class="td"><input class="input" type="text" name="place" placeholder="Fair 전시구역" required="required"></td>
				</tr>
				<tr>
