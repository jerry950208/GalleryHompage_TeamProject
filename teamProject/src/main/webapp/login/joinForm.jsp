...
<link rel="stylesheet" type="text/css" href="../css/login.css?v=0.2">
	...
	<form action="join.do" method="post" name="frm" id="form" onsubmit="check(); return false;">
	    <table align="center" id="table">
	        ...
	        <tr>
	            <td class="td">성별</td>
	            <td class="td">
	                <input type="radio" name="gender" value="남"><label class="gender" style="display:inline-block; width:10px;">남</label>
	                <input type="radio" name="gender" value="여"><label class="gender" style="display:inline-block; width:10px;">여</label>
	            </td>
	        </tr>
	        <tr>
	            <td class="td">E-mail</td>
	            <td class="td">
	                <input type="text" name="email1" class="mail" style="width: 42%;">&nbsp;@&nbsp;
