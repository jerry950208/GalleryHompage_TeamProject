...
<body>
	<div id="artist_main">
		<div id="artist_header">
			<div id="artist_group">
				<div>
					<input type="button" id="artist_group_gallery" value="BK Artist">
				</div>
				<div>
					<input type="button" id="artist_group_project" value="Project Artist">
				</div>
			</div>
		</div>
					...
					<a href="artist_info.do?artist=${dto.eng_name}" id="artist_info" class="artist_info">
						<div class="artist_info_content">
							<img src="${dto.head_img }" width="200px" height="217px"
								class="artist_info_image" style="visibility: hidden" />
							<div>
